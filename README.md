...
-   **Тон голосу (Tone of Voice):** Бот повинен дотримуватися професійного тону комунікації, із моливими легкими та ледь помітним жартами/підколами.
...
- [ ] **Задачі:**
    ...
    - [ ] Підключення до Discord API, реалізація базового клієнта, що може реагувати на події.
    - [ ] Створення обробника слеш-команд, що дозволяє реєструвати та виконувати прості команди.
...
- [ ] **Задачі:**
    ...
    - [ ] Налаштування інтерактивних елементів (кнопки підтвердження, випадаючі списки, пагінація).
...
- [ ] **Задачі:**
    - [ ] Розгортання базової інфраструктури для веб-додатку (Frontend/Backend).
    ...
    - [ ] Налаштування взаємодії між веб-додатком та ботом для публікації повідомлень.
